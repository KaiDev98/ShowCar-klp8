    ...
    <div class="flex-1 flex flex-col">
      ...
      <header class="bg-white p-4 shadow flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-4">
          ...
          <span class="text-sm"><?php echo htmlspecialchars($_SESSION['admin_username']); ?></span>
            ...
            <table class="min-w-full text-sm text-left border border-gray-200">
              <thead class="bg-blue-600 text-white">
                <tr>
                  ...
                  <th class="p-2 border">ID Merek</th>
              ...
              <tbody>
                <?php $no = 1; while ($row = $result->fetch_assoc()): ?>
                  <tr class="hover:bg-gray-100">
                    ...
                    <td class="p-2 border"><?php echo htmlspecialchars($row['nama_mobil']); ?></td>
                    <td class="p-2 border"><?php echo htmlspecialchars($row['id_merek']); ?></td>
                    <td class="p-2 border"><?php echo htmlspecialchars($row['id_kategori']); ?></td>
                    <td class="p-2 border">Rp <?php echo number_format($row['harga'], 0, ',', '.'); ?></td>
                    <td class="p-2 border space-x-1">
                      <a href="editMobil.php?id=<?php echo $row['id_mobil']; ?>" class="text-blue-600 hover:underline">Edit</a>
                      <a href="hapusMobil.php?id=<?php echo $row['id_mobil']; ?>" onclick="return confirm('Yakin ingin menghapus?')" class="text-red-600 hover:underline">Hapus</a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
