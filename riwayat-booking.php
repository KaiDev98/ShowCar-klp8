...
// Ambil data booking berdasarkan email user
$sql = "SELECT * FROM booking_test_drive WHERE email = ? ORDER BY created_at DESC";
          ...
          <tbody>
            <?php $no = 1; while ($row = $result->fetch_assoc()): ?>
              <tr class="hover:bg-gray-100">
                ...
                <td class="p-3 border"><?= htmlspecialchars($row['merk_mobil']) ?></td>
